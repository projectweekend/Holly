...
SensorReadingSchema.statics = {
    ...
    chartReadings: function ( numberOfReadings, cb ) {
        var q = this.find( {} )
    ...
    calcStatsOverDateRange: function ( startDate, endDate, cb ) {
        var matchOptions = {
            date: {
                $gte: startDate,
                $lte: endDate
...
SensorStatsSchema.statics = {
    ...
    chartReadings: function ( options, cb ) {
